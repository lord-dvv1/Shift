...
//import java.time.LocalTime; // Or Instant, LocalDateTime if that's your type
...
//
//    @Override
//    @Transactional // Essential for saving entities with relationships
//    public void run(String... args) throws Exception {
//        loadRoles();
//        loadUsers(); // Load users after roles are available
//        loadRooms();
//        loadTeachers();
...
//        // Use findByUsername instead of count() == 0, as you might have other users
//        // or for more specific checks if a particular admin user exists.
//        // If findByUsername is not defined, adjust your UserRepository to include it.
//        Optional<Users> existingAdmin = userRepository.findByUsername("admin");
//
//        if (existingAdmin.isEmpty()) { // Check if admin user doesn't exist
...
//                    .createdAt(LocalDateTime.now()) // <--- Now using LocalDateTime
//                    .updatedAt(LocalDateTime.now()) // <--- Now using LocalDateTime
//                    .build();
...
//
//            // Fetch existing rooms and teachers
...
//            Room room202 = rooms.get(1); // Assuming at least two rooms are created
//
//            Teacher teacherJohn = teachers.get(0);
//            Teacher teacherJane = teachers.get(1); // Assuming at least two teachers are created
//
//            // Create Students
...
//                    .build();
//
//            // Assign students to groups (assuming ManyToMany relationship)
...
//            studentsInPhysicsGroup.add(studentB); // Student B is in both groups
